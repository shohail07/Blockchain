...
int main(int argc, char *argv[]) {
    ...
    AnimationInterface anim("extended-lte-04/net-latency_2.xml");
...
std::ofstream plotFile("latency_2.plot");
plotFile << "set terminal png\n";
plotFile << "set output 'latency_2.png'\n";
...
system("gnuplot -p latency_2.plot");
